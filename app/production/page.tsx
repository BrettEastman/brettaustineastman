export default function Production() {
  ...
  return (
    <>
      <h3 className="flex justify-around uppercase text-3xl p-8 mt-4">Production</h3>
      <div className="flex flex-col max-w-5xl m-auto h-screen">
        <div className="leading-relaxed text-lg">
          ...
          <ul className={ulClass}>
            <a className={aClass} href="https://youtu.be/aqXun83bywc"><em>Andy Human and the Reptoids – Kill The Comma/Do The Mole</em></a>, 7″ single (Emotional Response 2017)
          </ul>
          <ul className={ulClass}>
            <a className={aClass} href="https://soundcloud.com/totalpunkrecords/andy-human-the-reptoids-refrigerator"><em>Andy Human and the Reptoids – Refrigerator/You Don’t Even Know</em></a>, 7″ single (Total Punk 2017)
          </ul>
          <ul className={ulClass}>
            <a className={aClass} href="https://soundcloud.com/goodbye-boozy-records/andy-human-and-the-repts-exist-in-piss"><em>Andy Human and the Reptoids – Pee Pee EP</em></a>, 7″ EP (Goodbye Boozy 2017)
          </ul>
          <ul className={ulClass}>
